...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.browseButton.setGeometry(QtCore.QRect(260, 50, 41, 23))
        self.browseButton.setObjectName("browseButton")
        self.analyzeButton = QtWidgets.QPushButton(Form)
        self.analyzeButton.setGeometry(QtCore.QRect(50, 160, 75, 23))
        self.analyzeButton.setObjectName("analyzeButton")
        self.openxlsx = QtWidgets.QPushButton(Form)
        self.openxlsx.setGeometry(QtCore.QRect(180, 160, 75, 23))
        ...
        self.ptoId_label.setGeometry(QtCore.QRect(30, 110, 71, 16))
        self.ptoId_label.setObjectName("ptoId_label")
        self.infolabel = QtWidgets.QLabel(Form)
        self.infolabel.setGeometry(QtCore.QRect(50, 200, 201, 31))
        font = QtGui.QFont()
